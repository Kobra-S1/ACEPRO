 ...
 *LV_DITHER_GRADIENT implies LV_GRADIENT_MAX_STOPS = 2 (see above)*/
...
#define LV_USE_IME_PINYIN 0
    ...
    /*If you do not use the default thesaurus, be sure to use `lv_ime_pinyin` after `lv_ime_pinyin_init`.*/
